...
{
    internal class AddButtonPresenter
    {
        ...
        public AddButtonPresenter(MyForm view, TextBox nameTextBox, TextBox dateTextBox, TextBox adressTextBox, TextBox skillTextBox)
        {
            this.view = view;
